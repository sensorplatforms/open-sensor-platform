...
int bma2x2_read_accel_x(short *a_x)
{
	...
	if (p_bma2x2 == C_BMA2x2_Zero_U8X) {
		...
		case BMA2x2_12_RESOLUTION:
			...
			*a_x =
				BMA2x2_GET_BITSLICE(data[0],
									BMA2x2_ACC_X12_LSB) |
				(BMA2x2_GET_BITSLICE(data[1], BMA2x2_ACC_X_MSB) << (BMA2x2_ACC_X12_LSB__LEN));
		...
		case BMA2x2_10_RESOLUTION:
			...
			*a_x =
				BMA2x2_GET_BITSLICE(data[0],
									BMA2x2_ACC_X10_LSB) |
				(BMA2x2_GET_BITSLICE(data[1], BMA2x2_ACC_X_MSB) << (BMA2x2_ACC_X10_LSB__LEN));
		...
		case BMA2x2_8_RESOLUTION:
			...
			*a_x =
				BMA2x2_GET_BITSLICE(data[0],
									BMA2x2_ACC_X8_LSB) |
				(BMA2x2_GET_BITSLICE(data[1], BMA2x2_ACC_X_MSB) << (BMA2x2_ACC_X8_LSB__LEN));
		...
		case BMA2x2_14_RESOLUTION:
			...
			*a_x =
				BMA2x2_GET_BITSLICE(data[0],
									BMA2x2_ACC_X14_LSB) |
				(BMA2x2_GET_BITSLICE(data[1], BMA2x2_ACC_X_MSB) << (BMA2x2_ACC_X14_LSB__LEN));
	...
	if (p_bma2x2 == C_BMA2x2_Zero_U8X) {
		...
		case BMA2x2_12_RESOLUTION:
			...
			*a_y =
				BMA2x2_GET_BITSLICE(data[0],
									BMA2x2_ACC_Y12_LSB) |
				(BMA2x2_GET_BITSLICE(data[1], BMA2x2_ACC_Y_MSB) << (BMA2x2_ACC_Y12_LSB__LEN ));
		...
		case BMA2x2_10_RESOLUTION:
			...
			*a_y =
				BMA2x2_GET_BITSLICE(data[0],
									BMA2x2_ACC_Y10_LSB) |
				(BMA2x2_GET_BITSLICE(data[1], BMA2x2_ACC_Y_MSB) << (BMA2x2_ACC_Y10_LSB__LEN ));
		...
		case BMA2x2_8_RESOLUTION:
			...
			*a_y =
				BMA2x2_GET_BITSLICE(data[0],
									BMA2x2_ACC_Y8_LSB) |
				(BMA2x2_GET_BITSLICE(data[1], BMA2x2_ACC_Y_MSB) << (BMA2x2_ACC_Y8_LSB__LEN ));
		...
		case BMA2x2_14_RESOLUTION:
			...
			*a_y =
				BMA2x2_GET_BITSLICE(data[0],
									BMA2x2_ACC_Y14_LSB) |
				(BMA2x2_GET_BITSLICE(data[1], BMA2x2_ACC_Y_MSB) << (BMA2x2_ACC_Y14_LSB__LEN ));
	...
	if (p_bma2x2 == C_BMA2x2_Zero_U8X) {
		...
		case BMA2x2_12_RESOLUTION:
			...
			*a_z =
				BMA2x2_GET_BITSLICE(data[0],
									BMA2x2_ACC_Z12_LSB) |
				(BMA2x2_GET_BITSLICE(data[1], BMA2x2_ACC_Z_MSB) << (BMA2x2_ACC_Z12_LSB__LEN));
		...
		case BMA2x2_10_RESOLUTION:
			...
			*a_z =
				BMA2x2_GET_BITSLICE(data[0],
									BMA2x2_ACC_Z10_LSB) |
				(BMA2x2_GET_BITSLICE(data[1], BMA2x2_ACC_Z_MSB) << (BMA2x2_ACC_Z10_LSB__LEN));
		...
		case BMA2x2_8_RESOLUTION:
			...
			*a_z =
				BMA2x2_GET_BITSLICE(data[0],
									BMA2x2_ACC_Z8_LSB) |
				(BMA2x2_GET_BITSLICE(data[1], BMA2x2_ACC_Z_MSB) << (BMA2x2_ACC_Z8_LSB__LEN));
		...
		case BMA2x2_14_RESOLUTION:
			...
			*a_z =
				BMA2x2_GET_BITSLICE(data[0],
									BMA2x2_ACC_Z14_LSB) |
				(BMA2x2_GET_BITSLICE(data[1], BMA2x2_ACC_Z_MSB) << (BMA2x2_ACC_Z14_LSB__LEN));
...
int bma2x2_read_accel_xyz(bma2x2acc_t *acc)
{
	...
	if (p_bma2x2 == C_BMA2x2_Zero_U8X) {
		...
		case BMA2x2_12_RESOLUTION:
			...
			data[0] = BMA2x2_GET_BITSLICE(data[0], BMA2x2_ACC_X12_LSB);
			acc->x = (short) (((unsigned short) data[1] << BMA2x2_ACC_X12_LSB__POS) | data[0]);
			if (data[1] & 0x80) {
				acc->x |= 0xf000;
			}

			data[2] = BMA2x2_GET_BITSLICE(data[2], BMA2x2_ACC_Y12_LSB);
			acc->y = (short) (((unsigned short) data[3] << BMA2x2_ACC_Y12_LSB__POS) | data[2]);
			if (data[3] & 0x80) {
				acc->y |= 0xf000;
			}

			data[4] = BMA2x2_GET_BITSLICE(data[4], BMA2x2_ACC_Z12_LSB);
			acc->z = (short) (((unsigned short) data[5] << BMA2x2_ACC_Z12_LSB__POS) | data[4]);
			if (data[5] & 0x80) {
				acc->z |= 0xf000;
			}
#if 0
			...
			acc->y =
				BMA2x2_GET_BITSLICE(data[2],
									BMA2x2_ACC_Y12_LSB) |
				(BMA2x2_GET_BITSLICE(data[3], BMA2x2_ACC_Y_MSB) << (BMA2x2_ACC_Y12_LSB__LEN ));
			acc->y = acc->y << (sizeof(short) * 8 - (BMA2x2_ACC_Y12_LSB__LEN + BMA2x2_ACC_Y_MSB__LEN));
			acc->y = acc->y >> (sizeof(short) * 8 - (BMA2x2_ACC_Y12_LSB__LEN + BMA2x2_ACC_Y_MSB__LEN));

			acc->z =
				BMA2x2_GET_BITSLICE(data[4],
									BMA2x2_ACC_Z12_LSB) |
				(BMA2x2_GET_BITSLICE(data[5], BMA2x2_ACC_Z_MSB) << (BMA2x2_ACC_Z12_LSB__LEN));
		...
		case BMA2x2_10_RESOLUTION:
			...
			acc->y =
				BMA2x2_GET_BITSLICE(data[2],
									BMA2x2_ACC_Y10_LSB) |
				(BMA2x2_GET_BITSLICE(data[3], BMA2x2_ACC_Y_MSB) << (BMA2x2_ACC_Y10_LSB__LEN ));
			...
			acc->z =
				BMA2x2_GET_BITSLICE(data[4],
									BMA2x2_ACC_Z10_LSB) |
				(BMA2x2_GET_BITSLICE(data[5], BMA2x2_ACC_Z_MSB) << (BMA2x2_ACC_Z10_LSB__LEN));
		...
		case BMA2x2_8_RESOLUTION:
			...
			acc->y =
				BMA2x2_GET_BITSLICE(data[2],
									BMA2x2_ACC_Y8_LSB) |
				(BMA2x2_GET_BITSLICE(data[3], BMA2x2_ACC_Y_MSB) << (BMA2x2_ACC_Y8_LSB__LEN ));
			...
			acc->z =
				BMA2x2_GET_BITSLICE(data[4],
									BMA2x2_ACC_Z8_LSB) |
				(BMA2x2_GET_BITSLICE(data[5], BMA2x2_ACC_Z_MSB) << (BMA2x2_ACC_Z8_LSB__LEN));
		...
		case BMA2x2_14_RESOLUTION:
			...
			acc->y =
				BMA2x2_GET_BITSLICE(data[2],
									BMA2x2_ACC_Y14_LSB) |
				(BMA2x2_GET_BITSLICE(data[3], BMA2x2_ACC_Y_MSB) << (BMA2x2_ACC_Y14_LSB__LEN ));
			...
			acc->z =
				BMA2x2_GET_BITSLICE(data[4],
									BMA2x2_ACC_Z14_LSB) |
				(BMA2x2_GET_BITSLICE(data[5], BMA2x2_ACC_Z_MSB) << (BMA2x2_ACC_Z14_LSB__LEN));
...
int bma2x2_set_range(unsigned char Range)
{
	...
	if (p_bma2x2 == C_BMA2x2_Zero_U8X) {
		...
		if ((Range == C_BMA2x2_Three_U8X) || (Range == C_BMA2x2_Five_U8X) || (Range == C_BMA2x2_Eight_U8X) ||
			...
			comres += p_bma2x2->BMA2x2_BUS_WRITE_FUNC(p_bma2x2->dev_addr,
...
{
	BMA2x2_RETURN_FUNCTION_TYPE comres = 0;
