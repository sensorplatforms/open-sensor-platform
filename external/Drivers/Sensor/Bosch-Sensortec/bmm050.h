 ...
 * bmm050.h
 *
 * Usage:        BMM050 Sensor Driver Support Header File
 *
 *****************************************************************************/
/****************************************************************************/
/*  Disclaimer
...
/* The LPC5102 sensor board has two magnetometers: BMC150 and BMM150. 
 * BMC150 is an Accel/Mag combo chip. Accel I2C address is 0x10. Mag I2C address is 0x12
 * BMM150 is an Mag only device with I2C address is 0x11.
 */
#define BMM050_I2C_ADDRESS                 (0x12)   //Use the BMC150 mag
