...
BMG160_RETURN_FUNCTION_TYPE bmg160_get_dataXYZ(struct bmg160_data_t *data)
{
	...
	if (p_bmg160 == BMG160_NULL) {
		...
		/* Data X */
		a_data_u8r[0] = BMG160_GET_BITSLICE(a_data_u8r[0], BMG160_RATE_X_LSB_VALUEX);

		data->datax = (BMG160_S16) (((BMG160_U16) a_data_u8r[1] << BMG160_RATE_X_LSB_VALUEX__LEN) |
									a_data_u8r[0]);
		/* Data Y */

		a_data_u8r[2] = BMG160_GET_BITSLICE(a_data_u8r[2], BMG160_RATE_Y_LSB_VALUEY);

		data->datay = (BMG160_S16) (((BMG160_U16) a_data_u8r[3] << BMG160_RATE_Y_LSB_VALUEY__LEN) |
									a_data_u8r[2]);
		/* Data Z */
		a_data_u8r[4] = BMG160_GET_BITSLICE(a_data_u8r[4], BMG160_RATE_Z_LSB_VALUEZ);
		data->dataz = (BMG160_S16) (((BMG160_U16) a_data_u8r[5] << BMG160_RATE_Z_LSB_VALUEZ__LEN) |
									a_data_u8r[4]);
	}
	return comres;
}
