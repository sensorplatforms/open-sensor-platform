...
void Pressure_HardwareSetup(osp_bool_t enable)
{
}
...
{
	MsgPressData p;
	bmp280.bus_write 	= dev_i2c_write;
	bmp280.bus_read		= dev_i2c_read;
	bmp280.delay_msec	= dev_i2c_delay;

	bmp280_init(&bmp280);
	bmp280_set_softreset();
	bmp280_set_workmode(BMP280_ULTRALOWPOWER_MODE);
	/* pressure_setDelay(pSens, 1000) */
#if 0
...
void Pressure_ReadData(MsgPressData *pressData)
{
	bmp280_read_pt((uint32_t *)&pressData->X, (int32_t *)&pressData->Z);
}
...
*/
/*******************************************************************************
 * Description: *//**\brief Used to get the Oversampling temperature
 *
 *
 *
 *
...
*/
/*******************************************************************************
 * Description: *//**\brief Used to set the Oversampling temperature
 *
 *
 *
 *
 *  \param unsigned char value : Value of the Oversampling temperature
 *
 *
 *
 *  \return
...
*/
/*******************************************************************************
 * Description: *//**\brief Used to get the Oversampling pressure
 *
 *
 *
 *
...
*/
/*******************************************************************************
 * Description: *//**\brief Used to set the Oversampling pressure
 *
 *
 *
 *
 *  \param unsigned char value : Value of the Oversampling pressure
 *
 *
 *
 *  \return
 ...
 * Soft reset can be easily set using BMP280_SOFT_RESET_CODE .
 * Usage Hint : bme280_set_softreset(BMP280_SOFT_RESET_CODE)
 *
 *  \param
 *
 *
